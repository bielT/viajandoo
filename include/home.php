      ...
      <nav class="navbar navbar-expand-lg fixed-top navbar-dark">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbar-links">
          <div class="navbar-nav">
            ...
            <a class="nav-item nav-link" id="login-menu" href="cadrastro.php"><img id="login" src="imagens/login.png"
                alt="login"></a>
          </div>
        </div>
      </nav>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption  d-md-block">
              ...
              <p>Conheça os lugare mais incríveis.</p>
              <a href="#passagem1" class="main-btn">Veja as opção</a>
            </div>
          </div>
          <div class="carousel-item">
            <img src="imagens/img-2.jpg" class="d-block  w-100" alt="Realizar o seu sonhos">
            <div class="carousel-caption d-md-block">
              <h2>Está querendo realizar o seu sonhos?</h2>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-caption d-md-block">
              ...
              <p>A Viajandoo conta com um equipe altamente qualificados para te ajudar?</p>
              <a href="#contato" class="main-btn">Entre em contato</a>
            </div>
          </div>
        </div>
      ...
      <div id="team-area">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-3">
              <a href="./passagemJR.php">
                <div class="card">

                  <img src="imagens/shot-by-cerqueira-lYgjpIWPfvg-unsplash.jpg" class="card-img-top"
                    alt="Imagem de Perfil 1">

                  <div class="card-body">
                    <h5 class="card-title">Rio de Janeiro</h5>
                    <p class="card-text">Até 6 de R$50,00 </p>
                  </div>
                </div>
              </a>
            </div>
            <div class="col-md-3">
              <a href="./passagemPrs.php">
                <div class="card">
                  <img src="imagens/anthony-delanoix-Q0-fOL2nqZc-unsplash.jpg" class="card-img-top"
                    alt="Imagem de Perfil 2">
                  <div class="card-body">
                    <h5 class="card-title">Paris</h5>
                    <p class="card-text">Até 6 de R$100,00</p>
                  </div>
                </div>
              </a>
            </div>
            <div class="col-md-3">
              <a href="./passagemUSA.php">
                <div class="card">
                  <img src="imagens/gautam-krishnan-IPlsuS19I1g-unsplash.jpg" class="card-img-top"
                    alt="Imagem de Perfil 3">
                  <div class="card-body">
                    <h5 class="card-title">Nova York</h5>
                    <p class="card-text">Até 6 de R$150,00</p>
                  </div>
                </div>
              </a>
            </div>
